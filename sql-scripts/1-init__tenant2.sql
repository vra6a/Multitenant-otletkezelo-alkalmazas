...
CREATE TABLE IF NOT EXISTS tenant2.user (
...
CREATE TABLE IF NOT EXISTS tenant2.ideabox (
    `id` BIGINT NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT FKfl3suoghrss86b0d8hpy9plmt FOREIGN KEY (user_id) REFERENCES tenant2.user (id)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS tenant2.idea (
    `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tenant2.idea_juries (
...
CREATE TABLE IF NOT EXISTS tenant2.idea_likes (
    `idea_id` bigint NOT NULL,
    `user_id` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS tenant2.tag (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `name` varchar(255) DEFAULT NULL,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS tenant2.required_juries (
...
CREATE TABLE IF NOT EXISTS tenant2.score_sheet (
    `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tenant2.score_item (
    `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tenant2.comment (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `creation_date` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS tenant2.comment_likes (
...
CREATE TABLE IF NOT EXISTS tenant2.idea_tags (
    `idea_id` bigint NOT NULL,
