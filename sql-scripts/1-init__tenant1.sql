...
CREATE TABLE IF NOT EXISTS tenant1.user (
...
CREATE TABLE IF NOT EXISTS tenant1.ideabox (
    `id` BIGINT NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT FKfl3suoghrss86b0d8hpy9plmt FOREIGN KEY (user_id) REFERENCES tenant1.user (id)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS tenant1.idea (
    `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tenant1.idea_juries (
...
CREATE TABLE IF NOT EXISTS tenant1.idea_likes (
    `idea_id` bigint NOT NULL,
    `user_id` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS tenant1.tag (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `name` varchar(255) DEFAULT NULL,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS tenant1.required_juries (
...
CREATE TABLE IF NOT EXISTS tenant1.score_sheet (
    `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tenant1.score_item (
    `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tenant1.comment (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `creation_date` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS tenant1.comment_likes (
...
CREATE TABLE IF NOT EXISTS tenant1.idea_tags (
    `idea_id` bigint NOT NULL,
...
INSERT INTO tenant1.user VALUES (1,'t1admin','t1','admin','$2a$10$gQvW4fRsiRz0OwQud1iKwOfah76yHvmIl5TpOjVrUU8p0n7eMsIV2','ADMIN'),(2,'t1user','t1','user','$2a$10$jpBXnucbc.hMXz3phYtGAOhrdmQLEoJhpm0rT1NWgepuo3JKF39YC','USER'),(3,'t1jury','t1','jury','$2a$10$fOzMu6dZly/t6JX0m7YMkeu/4BUgLRzWBkLaBI4Nerl9lP0OeE.ra','JURY');
