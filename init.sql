...
DELIMITER ;;
CREATE PROCEDURE InitTables(schema_name VARCHAR(64))
BEGIN
    DECLARE stmt VARCHAR(100000);
    SET @stmt = CONCAT('USE ', schema_name, '; ',
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`ideabox` (
        `id` bigint NOT NULL AUTO_INCREMENT,
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`idea` (
        `id` bigint NOT NULL AUTO_INCREMENT,
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`idea_juries` (
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`idea_likes` (
        `idea_id` bigint NOT NULL,
        `user_id` bigint NOT NULL,
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`required_juries` (
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`score_sheet` (
        `id` bigint NOT NULL AUTO_INCREMENT,
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`score_item` (
        `id` bigint NOT NULL AUTO_INCREMENT,
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`comment` (
        `id` bigint NOT NULL AUTO_INCREMENT,
        `creation_date` datetime DEFAULT NULL,
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`comment_likes` (
        ...
        'CREATE TABLE IF NOT EXISTS `', schema_name, '`.`idea_tags` (
        `idea_id` bigint NOT NULL,
...
CALL InitTables('default_tenant');
CALL InitTables('tenant1');
CALL InitTables('tenant2');